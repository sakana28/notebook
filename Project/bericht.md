...
## Linux
Ich habe einige Erfahrungen gesammelt, nachdem ich meine Hauptaufgabe erfüllt hatte, die darin bestand, Bildverarbeitungsfunktionen zu implementieren, indem ich die Hardware auf der PL-Seite und das BareMetal-Programm auf der PS-Seite entwickelte. Als nächstes habe ich mein Wissen erweitert, um Linux auf dem Zynq zu betrachten. Dabei habe ich das PetaLinux-Tool verwendet, das eine einfache, schnelle und effiziente Möglichkeit bietet, ein Embedded-Linux-Image für den Zynq-Prozessor zu erstellen und anzupassen.
